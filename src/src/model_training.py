...
from utils import log_daily_run, FEATURES

MODEL_PATH = "models/latest_model.keras"

def build_simple_nn(input_dim):
    """Constructs a high-capacity neural network for binary trend detection."""
...
def run_pipeline_cycle():
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        model.fit(X_scaled, y, epochs=60, batch_size=4, verbose=0)
